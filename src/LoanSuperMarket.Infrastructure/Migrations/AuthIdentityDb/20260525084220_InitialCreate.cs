...
namespace LoanSuperMarket.Infrastructure.Migrations.AuthIdentityDb
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountStatusReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AccountStatusChangedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AccountStatusChangedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    ...
                    CapitalLimit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    BlockedActivity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TwoFactorSetupComplete = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    RefreshTokenId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
